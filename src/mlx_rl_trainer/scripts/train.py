...
# Robust sys.path modification to handle both direct execution and installed package
...
async def mainx():
    ...
    paged_kv_cache = None  # Will be initialized inside trainer

...
class TrainerParams(BaseModel):
    ...
    lr_warmup_steps: PositiveInt = Field(100)
    ...
    min_think_tokens: PositiveInt = Field(
        16,
        description="Minimum number of tokens for the thinking part of the generation.",
    )
    max_think_tokens: PositiveInt = Field(
        128,
        description="Maximum number of tokens for the thinking part of the generation.",
    )
    ...
    ppo_clip_param: NonNegativeFloat = Field(0.2)
    ...
    boost_answer_grad_layers: bool = Field(False)
    ...
    # sft_think_loss_weight: Optional[NonNegativeFloat] = Field(0.05)

    # sft_answer_weight_loss_weight: Optional[NonNegativeFloat] = Field(0.05)

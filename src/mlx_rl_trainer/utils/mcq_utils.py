...
from mlx_rl_trainer.utils.text_utils import extract_answer_region, _normalize_ans_for_match, LETTER_ALPH, _letters_to_canonical

def _extract_predicted_letters(generated_text: str, options: Optional[List[str]], cfg: GenerationConfig) -> str:
    """
